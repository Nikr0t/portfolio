...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (navBurger && navToggle && navLinksMenu) {
        ...
        // Prevent default label behavior and handle click manually
        ...
        // Also handle clicks on spans inside the burger
        navBurger.querySelectorAll('span').forEach(span => {
        ...
        // Watch for checkbox changes (in case CSS is also controlling it)
